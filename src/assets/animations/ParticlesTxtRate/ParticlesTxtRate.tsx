...
import styles from './ParticlesTxtRate.module.scss'
...
const NUM_PARTICLES = 45 // плотность частиц с линиями
const FREE_PARTICLES = 20 // плотность «свободных» частиц без линий
...
const ParticlesTxtRate: React.FC = () => {
...
export default ParticlesTxtRate
